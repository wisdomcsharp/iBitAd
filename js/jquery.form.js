...
function contactFormResponse(response) {
  if (response.responseStatus == 'err') {
    ...
    var container = $('.wpb-contact-form-container').parent();
    $('.wpb-contact-form-container').fadeOut(500, function(){
      container.append('<h3 style="display:none;">Thank you for contacting us!</h3>');
      $('h3', container).fadeIn(500);
    });
    return false;
  } else {
    alert('Undocumented error. Please refresh the page and try again.');
